...
//                                 <Form.Control className="text-white bg-success" as="select" name="category" value={formData.category} onChange={handleChange} required>
//                                     <option value="">Select City Area</option>
//                                     <option value="car">Lahore </option>
//                                     <option value="bike">Karachi</option>
//                                     <option value="bike">Kasur</option>
//                                     <option value="bike">Deer</option>
//                                     <option value="bike">Nankana Sahib</option>
//                                     <option value="bike">Murree</option>
//                                     <option value="bike">Islamabad</option>
//                                     <option value="bike">Gujranwala</option>
//                                     <option value="bike">Sialkot</option>
//                                     <option value="bike">Jhelem</option>
//                                     <option value="bike">Mian Channu</option>
//                                 </Form.Control>
//                             </Form.Group>
//                         </Col>
